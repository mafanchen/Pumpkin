...
public class GSYVideoOptionBuilder {
    ...
    //亮度进度条样式
    protected Drawable mBrightProgressDrawable;
     ...
     * 亮度进度条
     */
    public GSYVideoOptionBuilder setDialogBrightProgressBar(Drawable drawable) {
    ...
    public void build(StandardGSYVideoPlayer gsyVideoPlayer) {
        ...
        if (mBrightProgressDrawable != null) {
            gsyVideoPlayer.setDialogBrightProgressBar(mBrightProgressDrawable);
        }
