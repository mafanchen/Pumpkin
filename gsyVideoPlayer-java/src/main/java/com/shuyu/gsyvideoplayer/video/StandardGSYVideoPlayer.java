...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    private Drawable mBrightProgressDrawable;
    ...
    protected void showBrightnessDialog(float percent) {
        ...
        if (mBrightnessProgressBar != null)
            mBrightnessProgressBar.setProgress((int) (percent * 100));
    }
    ...
    private void initFullUI(StandardGSYVideoPlayer standardGSYVideoPlayer) {
        ...
        if (mBrightProgressDrawable != null) {
            standardGSYVideoPlayer.setDialogBrightProgressBar(mBrightProgressDrawable);
        }
    ...
    public void setDialogBrightProgressBar(Drawable drawable) {
        mBrightProgressDrawable = drawable;
    }
