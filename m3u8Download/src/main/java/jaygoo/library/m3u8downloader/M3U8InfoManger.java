...
public class M3U8InfoManger {
     ...
     */
    public synchronized void getM3U8Info(final String url, final String videoId, final String videoName, OnM3U8InfoListener onM3U8InfoListener) {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    M3U8 m3u8 = MUtils.parseIndex(url, videoId, videoName);
                    handlerSuccess(m3u8);
                } catch (IOException e) {
                    handlerError(e);
                }
