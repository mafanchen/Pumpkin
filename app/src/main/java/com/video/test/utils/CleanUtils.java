...
public class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return FileUtils.deleteFilesInDir(TestApp.getInstance().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return FileUtils.deleteFilesInDir(TestApp.getInstance().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return FileUtils.deleteFilesInDir(TestApp.getInstance().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName(String dbName) {
        return TestApp.getInstance().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return FileUtils.deleteFilesInDir(TestApp.getInstance().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return SDCardUtils.isSDCardAvailable() && FileUtils.deleteFilesInDir(TestApp.getInstance().getExternalCacheDir());
    }
