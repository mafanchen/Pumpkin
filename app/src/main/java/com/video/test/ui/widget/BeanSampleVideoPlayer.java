...
/**
 * @author Enoch Created on 2018/8/16.
 */
public class BeanSampleVideoPlayer extends StandardGSYVideoPlayer {
    ...
    public BeanSampleVideoPlayer(Context context, Boolean fullFlag) {
    ...
    public BeanSampleVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        BeanSampleVideoPlayer sampleVideo = (BeanSampleVideoPlayer) super.startWindowFullscreen(context, actionBar, statusBar);
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            BeanSampleVideoPlayer sampleVideo = (BeanSampleVideoPlayer) gsyVideoPlayer;
