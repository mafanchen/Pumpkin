...
public abstract class BaseLazyFragment<P extends BasePresenter> extends Fragment implements IView, EasyPermissions.PermissionCallbacks {
    protected boolean isVisible;
    protected boolean isViewPrepared;
    protected P mPresenter;
    protected boolean isLoad = true;
    // isHandle 用来判断是否处理埋点信息
    ...
    public void onResume() {
        super.onResume();
        LogUtils.d(getClass(), "onResume Visible : " + isVisible);
        if (isVisible) {
            //阿里云Fragment 页面埋点
    ...
    public void onPause() {
        super.onPause();
        LogUtils.d(getClass(), "onPause Visible : " + isVisible);
        if (isHandle) {
            //友盟收集页面埋点信息
    ...
    protected void onVisible() {
        LogUtils.d(getClass(), "onVisible" + "当前页面可见");
        isCanLazyLoad();
    }

    protected void onInvisible() {
        LogUtils.d(getClass(), "onInvisible" + "当前页面不可见");
    }
