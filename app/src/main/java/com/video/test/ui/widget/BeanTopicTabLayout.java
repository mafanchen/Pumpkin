 ...
 */
public class BeanTopicTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public BeanTopicTabLayout(Context context) {
        this(context, null, 0);
    }

    public BeanTopicTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeanTopicTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mValueAnimator = ValueAnimator.ofObject(new BeanTopicTabLayout.PointEvaluator(), mLastP, mCurrentP);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            // 选中时为 22SP 未选中为 18SP
            tab_title.setTextSize(TypedValue.COMPLEX_UNIT_SP, isSelect ? 22 : 18);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        View currentTabView = mTabsContainer.getChildAt(this.mCurrentTab);
        BeanTopicTabLayout.IndicatorPoint p = (BeanTopicTabLayout.IndicatorPoint) animation.getAnimatedValue();
    ...
    private BeanTopicTabLayout.IndicatorPoint mCurrentP = new BeanTopicTabLayout.IndicatorPoint();
    private BeanTopicTabLayout.IndicatorPoint mLastP = new BeanTopicTabLayout.IndicatorPoint();

    class PointEvaluator implements TypeEvaluator<BeanTopicTabLayout.IndicatorPoint> {
        @Override
        public BeanTopicTabLayout.IndicatorPoint evaluate(float fraction, BeanTopicTabLayout.IndicatorPoint startValue, BeanTopicTabLayout.IndicatorPoint endValue) {
            float left = startValue.left + fraction * (endValue.left - startValue.left);
            float right = startValue.right + fraction * (endValue.right - startValue.right);
            BeanTopicTabLayout.IndicatorPoint point = new BeanTopicTabLayout.IndicatorPoint();
            point.left = left;
            point.right = right;
            return point;
        }
